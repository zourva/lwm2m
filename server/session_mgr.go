...
// RegistrationSessionManager manages the
// registration session of a client.
type RegistrationSessionManager struct {
...
func (r *RegistrationSessionManager) Start() {
	go r.loop()
}

func (r *RegistrationSessionManager) Stop() {
	r.quit <- true
}

// loop used to maintain session states.
func (r *RegistrationSessionManager) loop() {
...
func (r *RegistrationSessionManager) removeStale() {
	r.lock.Lock()
	defer r.lock.Unlock()
...
func (r *RegistrationSessionManager) delete(session core.RegisteredClient) {
	delete(r.sessions, session.Name())
	delete(r.indexLoc, session.Location())
	delete(r.indexAddr, session.Address())
}

func (r *RegistrationSessionManager) genLocation(epName string) string {
...
func (r *RegistrationSessionManager) GetByAddr(addr string) core.RegisteredClient {
	r.lock.Lock()
	defer r.lock.Unlock()
...
func (r *RegistrationSessionManager) GetByLocation(location string) core.RegisteredClient {
	r.lock.Lock()
	defer r.lock.Unlock()
...
func (r *RegistrationSessionManager) Get(name string) core.RegisteredClient {
	r.lock.Lock()
	defer r.lock.Unlock()
...
func (r *RegistrationSessionManager) Create(info *core.RegistrationInfo) core.RegisteredClient {
	r.lock.Lock()
	defer r.lock.Unlock()
...
func (r *RegistrationSessionManager) Update(info *core.RegistrationInfo) error {
...
func (r *RegistrationSessionManager) Delete(name string) {
...
func (r *RegistrationSessionManager) DeleteByLocation(location string) {
